...
export const Unassigneduserstories = (props) => {
    ...
    useEffect(() => {
        axios.get(`http://localhost:9000/getunassigneduserstoriesByUserId/${user_id}`,{
            params:{
            User_Id:user_id,
        }
        }) 
    ...
    const handleAssign = (user_story_id,user_id) => {
        axios.post(`http://localhost:9000/createassigneduserstory` ,{ user_story_id,user_id})
                    ...
                    { 
                        userstories.map(userstory => {
                            return <tr key={userstory._id}>
                                ...
                                <td><button class="nav" onClick={() => handleAssign(userstory._id, user_id)}>assign</button>
